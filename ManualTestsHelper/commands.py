...
def main():
    ...
    if (input() == "1"):
        ...
        keyboard.add_hotkey("alt+p", lambda: GetCashboxId.execute())
        keyboard.add_hotkey("alt+i", lambda: CacheCashboxId.execute())
        ...
        keyboard.add_hotkey('alt+~', lambda: main())
