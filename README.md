...
|ALT + k | Выбрать ККТ и терминалы | В терминале надо будет указать 1-2 ККТ и 1-2 терминала. Они пропишутся в настройках и соответственно включатся режимы 1ЮЛ или 2ЮЛ |
